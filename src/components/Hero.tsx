            ...
            <p className=" px-4 text-base font-light text-zinc-400 md:px-0">
              {language === 'en' ? (
                <>
                  ...
                  , a Senior Frontend Engineer. 7 years of experience. Currently
                  I have worked with the following technologies: React, NextJS,
                ...
                <>
                  ...
                  Atualmente tenho trabalhado com as seguintes tecnologias:
                  React, NextJS, Styled Components, Tailwind CSS, Zustand,
                  Immer, Axios, Jest, Testing Library, Storybook, Figma, Git,
            ...
            <p className="px-4 text-base font-light text-zinc-400 md:px-0">
              {language === 'en' ? (
                <>
                  ...
                  Universidade Paulista. My expertise encompasses React,
                  Next.js, and Typescript, which are fundamental in creating web
                  solutions that optimize user experience. With certifications
                  from Rocketseat, I have enhanced my skills in CI/CD,
                  significantly contributing to interface innovation and
                  actively collaborating to align business strategies with
                  technology. Our team values collaboration and the constant
                ...
                <>
                  ...
                  React, Next.js e Typescript, fundamentais na criação de
                  soluções web que otimizam a experiência do usuário. Com as
                  certificações da Rocketseat, aprimorei minha habilidade em
                  CI/CD, contribuindo significativamente para a inovação de
                  interfaces e colaborando ativamente para alinhar estratégias
                  de negócios com a tecnologia. Nossa equipe valoriza a
                  colaboração e a busca constante por melhorias nas práticas de
                  desenvolvimento.
                </>
              )}
            </p>
